...
@ContextConfiguration(classes = { PlaceJsonImportBatchConfiguration.class })
public class PlaceJsonImportJobTest {
    ...
    private final static String TEST_INPUT = "src/test/resources/input.json";
    private final static String JOB_NAME = "placeJsonImportJob";
