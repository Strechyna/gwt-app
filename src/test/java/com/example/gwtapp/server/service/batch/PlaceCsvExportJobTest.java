...
@ContextConfiguration(classes = { PlaceCsvExportBatchConfiguration.class })
public class PlaceCsvExportJobTest {
    ...
    private final static String TEST_OUTPUT = "src/test/resources/output.csv";
    private final static String JOB_NAME = "placeCsvExportJob";
